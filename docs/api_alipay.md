...
| --- | --- | --- |
| 请求方式 | POST |  |
| 请求地址 | {{baseUrl}}/api/Alipay/:appId/CreateOrderPagePay | :appId 部分需要替换为实际应用的 ID |
| 登陆凭证 | Bearer Token |  |
| `参数说明`  |  |  |
| orderNo | 系统订单号，必填 |
...
| --- | --- | --- |
| 请求方式 | POST |  |
| 请求地址 | {{baseUrl}}/api/Alipay/:appId/CreateOrderWapPay | :appId 部分需要替换为实际应用的 ID |
| 登陆凭证 | Bearer Token |  |
| `参数说明`  |  |  |
| orderNo | 系统订单号，必填 |
| amount | 商品金额，必填  | 最小值为0.01元 |
...
| --- | --- | --- |
| 请求方式 | GET |  |
| 请求地址 | {{baseUrl}}/api/Alipay/:appId/OrderDetail?orderNo= | :appId 部分需要替换为实际应用的 ID |
| 登陆凭证 | Bearer Token |  |
| `参数说明`  |  |  |
| orderNo | 系统订单号，必填 |
...
| --- | --- | --- |
| 请求方式 | POST |  |
| 请求地址 | {{baseUrl}}/api/Alipay/:appId/OrderRefund?amount=&orderNo= | :appId 部分需要替换为实际应用的 ID |
| 登陆凭证 | Bearer Token |  |
| `参数说明`  |  |  |
| orderNo | 系统订单号，必填 |
| amount | 退款金额，必填 |
...
| --- | --- | --- |
| 请求方式 | POST |  |
| 请求地址 | {{baseUrl}}/api/Alipay/:appId/ReturnPageNotify | :appId 部分需要替换为实际应用的 ID，:orderId 为订单ID |
| 登陆凭证 | Bearer Token |  |
| `参数说明`  | **所需参数均来自支付宝** |  |
| charset |  |  |
| out_trade_no |  |  |
