...
| --- | --- | --- |
| 请求方式 | GET |  |
| 请求地址 | {{baseUrl}}/api/AppChatMessages/:appId/Tables | :appId 部分需要替换为实际应用的 ID |
| 登陆凭证 | Bearer Token |  |
...
| --- | --- | --- |
| 请求方式 | GET |  |
| 请求地址 | {{baseUrl}}/api/AppChatMessages/:appId/:table/Categories | :appId 部分需要替换为实际应用的 ID；:table 需要替换为实际的消息表名称  |
| 登陆凭证 | Bearer Token |  |
...
| --- | --- | --- |
| 请求方式 | GET |  |
| 请求地址 | {{baseUrl}}/api/AppChatMessages/:appId/:table?category=&tag=&search=&take=10&skip=0 | :appId 部分需要替换为实际应用的 ID；:table 需要替换为实际的消息表名称 |
| 登陆凭证 | Bearer Token |  |
| `参数说明` |  |  |
| category | 消息组  |  |
| tag | 消息标签  |  |
...
| --- | --- | --- |
| 请求方式 | POST |  |
| 请求地址 | {{baseUrl}}/api/AppChatMessages/:appId/:table | :appId 部分需要替换为实际应用的 ID；:table 需要替换为实际的消息表名称 |
| 登陆凭证 | Bearer Token |  |
